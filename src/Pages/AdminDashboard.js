...
import WebPromotion from '../Components/AdminDashBoard/WebPromotion';
import Dashboard from '../Components/AdminDashBoard/MyDashboard/Dashboard';
...
const AdminDashboard = () => {
    ...
    let [userTool, setUserTool] = useState(Page);
    console.log(Page)
                ...
                <div className='md:w-[79.16%] w-full md:pl-[54px] md:pr-[17px]'>
                    ...
                    <div className=' w-full  overflow-hidden'>
                        <div className='relative Top-Bar pr-[45px] pl-[31px] flex justify-between items-center w-full h-[102px] border-b-[0.5px] border-[#414141]'>
                            ...
                            <div className='Name text-[#E93439] text-[32px] font-semibold leading-9'>Admin Dashboard</div>
                        ...
                        </div>
                        {
                            ...
                            Page==="Users"?
                            <Users/>:
                            <div className='mt-3 h-screen w-full rounded-[10px] bg-white'></div>
